...
import { FileText, Headphones, Mic, Briefcase, MessageCircle, Package } from "lucide-react"
      ...
      <AdminLayout>
        <div className="space-y-6">
          <div>
            ...
            <p className="text-muted-foreground mt-2">Welcome to the Ruqya Healing admin panel</p>
          </div>
